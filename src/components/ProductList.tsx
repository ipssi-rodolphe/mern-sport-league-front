...
interface ProductListProps {
  ...
  showActions?: boolean; // Nouvelle propriété optionnelle
}
...
const ProductList: React.FC<ProductListProps> = ({
  ...
  onUpdateClick,
  onDeleteClick,
  showActions = true, // Par défaut, les actions sont affichées
}) => {
        ...
        {products.length === 0 ? (
          ...
          products.map((product) => (
            ...
            >
              ...
              {/* Afficher les boutons seulement si showActions est vrai et l'utilisateur est admin */}
              {showActions && isAdmin && (
